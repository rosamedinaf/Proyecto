...
import com.example.innova.saborapp.fragment.dummy.DummyContent.DummyItem;
...
public class ItemRecetaRecyclerViewAdapter extends RecyclerView.Adapter<ItemRecetaRecyclerViewAdapter.ViewHolder> {
    ...
    public ItemRecetaRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
